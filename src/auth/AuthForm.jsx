...
const AuthForm = () => {
  ...
  async function signup() {
    ...
    try {
      ...
      console.log("Регистрация успешно:", res.user);
      ...
      <div className="auth-box">
        ...
        >
          ...
          <button type="submit" className="auth-button" disabled={loading}>
            {loading ? "Ожидайте..." : isLogin ? "Войти" : "Зарегистртироваться"}
          </button>
        </form>

        <p className="toggle-text" onClick={toggleForm}>
          {isLogin ? "Вы не прошли регистрацию?" : "Вы уже зарегистировались? Вход"}
        </p>
      </div>
      <ToastContainer />
    </div>
