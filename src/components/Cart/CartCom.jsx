  ...
  return (
    <div className='cart'>
        <div className="home-shop">
            <Link className='carthome' to={"/"}>Home </Link>
            /
            <Link className='cartshop' to={"/shop"}>  Shop</Link>
        </div>
        ...
        <div className="des-link">
            <Link className='des-product' to={"/cart"}>Product Description</Link>
