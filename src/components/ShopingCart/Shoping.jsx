  ...
  return (
    <div className="shopping">
      <div className="home-shopping">
        <Link className="shopping-home" to="/">
          Home
        </Link>{" "}
        /
        <Link className="shopping-shop" to="/shop">
          Shop
        </Link>{" "}
        /
        <Link className="shopping-cart" to="/shop">
          Shopping Cart
        </Link>
      </div>
            ...
            {cartItems.map((product) => (
              <div className="product-shopping" key={product.id}>
                ...
                <div className="shopping-price">
                  <span>
                    $
                    {(formatPrice(product.price) * product.quantity).toFixed(2)}
                  </span>
                </div>
